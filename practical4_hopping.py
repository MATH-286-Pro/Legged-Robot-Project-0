...
Fx_max = 1     # max peak force in X direction     # [TODO] ####################################################################
Fz_max = 1     # max peak force in Z direction     # [TODO] ####################################################################
f = 5          # frequency                         # [TODO] ####################################################################
...
for i in range(NUM_SECONDS*1000):
    ...
    # desired_force = kpCartesian @ ee_pos_err  # P控制器
    # desired_force = kpCartesian @ ee_pos_err - kdCartesian @ J @ env.robot.GetMotorVelocities() # PD控制器
    # tau += J.T @ desired_force # PD控制器
